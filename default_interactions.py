...
def lj_interaction_mixed(first_atom, second_atom, interaction_params):
    ...
    sigma = interaction_params[f'sigma-{first_atom.atom_type}-{second_atom.type}']
    dispersion = interaction_params[f'dispersion-{first_atom.atom_type}-{second_atom.type}']
    distance = np.linalg.norm(first_atom.position - second_atom.position)
